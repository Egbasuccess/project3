...
<body>
    ...
    <div class="body_area">
        <aside class="main_layout">
            <ul class="menu_list">
                <li class="menu_item"><a href="../user.php" style="text-decoration:none;"><button class="menu_btn">DASHBOARD</button></a></li>
                <li class="menu_item">
                ...
                <li class="menu_item">
                    ...
                    <ul class="submenu" id="acceptance">
                        ...
                        <li><a href="../acceptance/generate_receipt.php">Reprint Original Receipt</a></li>
                    </ul>
                </li>
                <li class="menu_item">
                    ...
                    <ul class="submenu active" id="admission">
                        <li><a href="admission_letter.php" style="color:#30e403;">Upload Credentials</a></li>
