...
if (isset($_POST['submit_faculty_docs'])) {
    ...
    $file_keys = [
        'jamb_adm', 'jamb_res', 'olevel_print', 'ebsu_acc', 
        'ebsu_adm', 'lg_id', 'post_utme', 'supp_form', 
        'attestation', 'birth_cert'
    ];
    ...
    if ($upload_ok) {
        // Update status to mark this stage as done
        mysqli_query($conn, "UPDATE login_table SET faculty_docs_status = 'Submitted' WHERE id = '$user_id'");
        
        echo "<script>
                alert('Credentials Uploaded Successfully! Proceeding to O-Level Verification.');
                window.location.href = 'olevel_verification.php';
              </script>";
        exit();
    } else {
        $msg = "<p style='color:red; font-weight:bold;'>Please upload all required documents.</p>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="body_area">
        ...
        <div class="body_div">
            <h2>Step 1: Upload Faculty Clearance Credentials</h2>
            ...
            <div class="upload-card">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="submit_faculty_docs" style="width:100%; padding:15px; background:#0e5001; color:white; border:none; border-radius:5px; font-weight:bold; cursor:pointer; margin-top:20px;">SAVE & CONTINUE</button>
                </form>
            </div>
        </div>
    </div>
